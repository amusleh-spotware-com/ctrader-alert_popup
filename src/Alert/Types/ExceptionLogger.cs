...
namespace cAlgo.API.Alert.Types
{
    public class ExceptionLogger
    {
        ...
        public static string GetSummary(Exception exception, bool addStackTrace = true, bool isInnerException = false, string intend = null)
        {
            ...
            if (exception.InnerException != null)
            {
                ...
                string innerExceptionSummary = GetSummary(exception.InnerException, isInnerException: true, intend: innerExceptionIntent);
        ...
        {
            string exceptionSummary = GetSummary(exception);

            Configuration.Tracer?.Invoke(exceptionSummary);
        }
